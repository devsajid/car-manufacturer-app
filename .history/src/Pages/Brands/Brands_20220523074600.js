...
import Brand1 from "../../Images/2.png";
import Brand1 from "../../Images/3.png";
import Brand1 from "../../Images/4.png";
import Brand1 from "../../Images/5.png";
import Brand1 from "../../Images/6.jpg";
import Brand1 from "../../Images/7.png";
import Brand1 from "../../Images/8.jpg";
import Brand1 from "../../Images/9.png";
import Brand1 from "../../Images/10.png";
import Brand1 from "../../Images/11.png";
import Brand1 from "../../Images/12.jpg";
const Brands = () => {
  return (
    <div>
      <div class="carousel w-full">
        <div id="1" class="carousel-item w-full">
          <img src="1.jpg" class="w-full" alt="brands" />
        </div>
        <div id="2" class="carousel-item w-full">
          <img src="2.png" class="w-full" alt="brands" />
        </div>
        <div id="3" class="carousel-item w-full">
          <img src="3.png" class="w-full" alt="brands" />
        </div>
        <div id="4" class="carousel-item w-full">
          <img src="4.png" class="w-full" alt="brands" />
        </div>
        <div id="5" class="carousel-item w-full">
          <img src="5.png" class="w-full" alt="brands" />
        </div>
        <div id="6" class="carousel-item w-full">
          <img src="6.jpg" class="w-full" alt="brands" />
        </div>
        <div id="7" class="carousel-item w-full">
          <img src="7.png" class="w-full" alt="brands" />
        </div>
        <div id="8" class="carousel-item w-full">
          <img src="8.jpg" class="w-full" alt="brands" />
        </div>
        <div id="9" class="carousel-item w-full">
          <img src="9.png" class="w-full" alt="brands" />
        </div>
        <div id="10" class="carousel-item w-full">
          <img src="10.png" class="w-full" alt="brands" />
        </div>
        <div id="11" class="carousel-item w-full">
          <img src="11.png" class="w-full" alt="brands" />
        </div>
        <div id="12" class="carousel-item w-full">
          <img src="12.jpg" class="w-full" alt="brands" />
        </div>
      </div>
