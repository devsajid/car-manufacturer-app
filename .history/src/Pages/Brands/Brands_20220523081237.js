  ...
  return (
    <div>
      <div class="carousel w-24">
        ...
        <div id="2" class="carousel-item w-24">
          <img src={brand2} class="w-24" alt="brands" />
        </div>
        <div id="3" class="carousel-item w-24">
          <img src={brand3} class="w-24" alt="brands" />
        </div>
        <div id="4" class="carousel-item w-24">
          <img src={brand4} class="w-24" alt="brands" />
        </div>
        <div id="5" class="carousel-item w-24">
          <img src={brand5} class="w-24" alt="brands" />
        </div>
        <div id="6" class="carousel-item w-24">
          <img src={brand6} class="w-24" alt="brands" />
        </div>
        <div id="7" class="carousel-item w-24">
          <img src={brand7} class="w-24" alt="brands" />
        </div>
        <div id="8" class="carousel-item w-24">
          <img src={brand8} class="w-24" alt="brands" />
        </div>
        <div id="9" class="carousel-item w-24">
          <img src={brand9} class="w-24" alt="brands" />
        </div>
        <div id="10" class="carousel-item w-24">
          <img src={brand10} class="w-24" alt="brands" />
        </div>
        <div id="11" class="carousel-item w-24">
          <img src={brand11} class="w-24" alt="brands" />
        </div>
        <div id="12" class="carousel-item w-24">
